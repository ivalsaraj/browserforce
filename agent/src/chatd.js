...
import {
  commentaryHeadingFromDelta,
  firstString,
  isBrowserForceExecutePayload,
  normalizeStepDetails,
  normalizeToolLabel,
  stepDetailsForRunEvent,
  stepDetailsForToolEvent,
  stepKeyForRunEvent,
  unwrapShellLcCommand,
} from '../../extension/agent-timeline-labels.js';
import {
